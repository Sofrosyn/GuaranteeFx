                ...
                <div class="uk-grid uk-flex uk-flex-center">
                    <div class="uk-width-1-2@m uk-text-center">
                        <h2 class="uk-margin-small-bottom">
                            Do not hesitate to <span class="in-highlight">reach out.</span>
                        </h2>
                                ...
                                @if($errors->any())
                                    <ul class="uk-list">
                                        @foreach($errors->all() as $e)
                                            <li><small class="uk-text-danger">{{ $e }}</small></li>
                                        @endforeach
                                    </ul>
                                @endif
                                <form id="contact-form" class="uk-form uk-grid-small" data-uk-grid method="post">
                                    @csrf
                                    <div class="uk-width-1-1">
                                        <input class="uk-input uk-border-rounded" id="name" name="full_name"
                                    ...
                                    <div class="uk-width-1-1">
                                        <input class="uk-input uk-border-rounded" id="subject" name="subject"
                                               value="{{ old('subject') }}" type="text" placeholder="Subject">
                                    </div>
                                    <div class="uk-width-1-1">
